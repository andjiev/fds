...
GO
INSERT [dbo].[Version] ([Id], [Name], [Channel], [CreatedOn], [PackageId]) VALUES (2, N'v.1.2', 1, DATEADD(day, -8, GETDATE()), 1)
GO
...
GO
INSERT [dbo].[Version] ([Id], [Name], [Channel], [CreatedOn], [PackageId]) VALUES (6, N'v.2.2', 2, DATEADD(day, -14, GETDATE()), 2)
GO
...
GO
INSERT [dbo].[Version] ([Id], [Name], [Channel], [CreatedOn], [PackageId]) VALUES (11, N'v.1.2', 1, DATEADD(day, -12, GETDATE()), 3)
GO
...
GO
INSERT [dbo].[Version] ([Id], [Name], [Channel], [CreatedOn], [PackageId]) VALUES (15, N'v.1.0', 1, DATEADD(day, -15, GETDATE()), 5)
GO
INSERT [dbo].[Version] ([Id], [Name], [Channel], [CreatedOn], [PackageId]) VALUES (16, N'v.1.1', 2, DATEADD(day, -7, GETDATE()), 5)
GO
...
UPDATE [dbo].[Package]
SET [dbo].[Package].[VersionId] = 2, [dbo].[Package].[VersionName] = N'v.1.2'
...
GO
UPDATE [dbo].[Package]
SET [dbo].[Package].[VersionId] = 16, [dbo].[Package].[VersionName] = N'v.1.1'
